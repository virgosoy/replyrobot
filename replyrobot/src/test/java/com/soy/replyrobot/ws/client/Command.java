...
/**
 * <p>command complex type的 Java 类。
 * 
 ...
 *         &lt;element name="contentList" type="{http://ws.replyrobot.soy.com/}commandContent" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Command {
    ...
    protected List<CommandContent> contentList;
    ...
    public List<CommandContent> getContentList() {
        if (contentList == null) {
            contentList = new ArrayList<CommandContent>();
        }
